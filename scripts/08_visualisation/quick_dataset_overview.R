...
#
# STATUS: exploratory visualisation retained for transparent development.
#
# Input:
#   data/metadata/curated_metadata_72_genomes.csv
#
# Output:
#   results/figures/dataset_overview/
...
#     amr_gene_count_frequency.csv
#     dataset_summary.csv
#     dataset_overview_cleaned.csv
#
# Changes in this version:
#   - Country-based graphs were removed.
#   - Plot colours now vary between figures.
#   - The AMR histogram was replaced with a ranked per-genome AMR plot.
#   - A frequency table is exported to show how many genomes have each AMR count.
# =============================================================================
